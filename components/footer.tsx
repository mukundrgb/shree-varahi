...
const footerLinks: Record<string, { name: string; href: string }[]> = {
  Trade: [
    ...
    { name: "Commodities MCX", href: "/commodity" },
    { name: "MTF", href: "/mtf" },
  ],
  Invest: [
...
const marketTabs: MarketTab[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "NFO Today", href: "/nfo" }, { name: "Fund Performance", href: "#" },
  ...
  },
  {
    ...
    label: "Commodities",
    links: [
      { name: "Gold MCX Live Rate", href: "/commodity" }, { name: "Silver MCX Rate", href: "/commodity" },
      { name: "Crude Oil MCX", href: "/commodity" }, { name: "Natural Gas MCX", href: "/commodity" },
      { name: "Copper MCX", href: "/commodity" }, { name: "Zinc MCX", href: "/commodity" },
      { name: "Lead MCX", href: "/commodity" }, { name: "Aluminium MCX", href: "/commodity" },
      { name: "MCX Live Rates", href: "/commodity" }, { name: "LME Rates Today", href: "/commodity" },
      { name: "Commodity Calendar", href: "/commodity" }, { name: "Delivery Data", href: "/commodity" },
      { name: "MCX Options", href: "/commodity" }, { name: "Commodity Futures", href: "/commodity" },
      { name: "Agri Commodities", href: "/commodity" }, { name: "Bullion Prices", href: "/commodity" },
      { name: "Commodity Margin", href: "/commodity" }, { name: "Gold vs Silver", href: "/commodity" },
      { name: "Crude Oil Analysis", href: "/commodity" }, { name: "Metal Watch", href: "/commodity" },
      { name: "Digital Gold", href: "/commodity" }, { name: "Gold ETF vs Physical", href: "/commodity" },
      { name: "MCX Circuit Limits", href: "/commodity" }, { name: "Commodity News", href: "/commodity" },
    ],
  },
  {
    id: "etf",
    label: "ETFs",
    links: [
      { name: "Nifty 50 ETF", href: "/etf" }, { name: "Bank Nifty ETF", href: "/etf" },
      { name: "Gold ETF", href: "/etf" }, { name: "Silver ETF", href: "/etf" },
      { name: "IT Sector ETF", href: "/etf" }, { name: "Pharma Sector ETF", href: "/etf" },
      { name: "International ETF", href: "/etf" }, { name: "Debt ETF", href: "/etf" },
      { name: "Lowest Expense ETF", href: "/etf" }, { name: "ETF Returns 2025", href: "/etf" },
      { name: "ETF vs Index Fund", href: "/etf" }, { name: "Liquid ETF", href: "/etf" },
      { name: "Best ETF 2025", href: "/etf" }, { name: "ETF Calculator", href: "/etf" },
      { name: "How to Invest in ETF", href: "/etf" }, { name: "All ETF List", href: "/etf" },
      { name: "Nifty Next 50 ETF", href: "/etf" }, { name: "Midcap 150 ETF", href: "/etf" },
      { name: "PSU Bank ETF", href: "/etf" }, { name: "Consumption ETF", href: "/etf" },
      { name: "CPSE ETF", href: "/etf" }, { name: "Bharat Bond ETF", href: "/etf" },
      { name: "ETF vs Mutual Fund", href: "/etf" }, { name: "ETF Taxation", href: "/etf" },
    ],
  },
  {
    id: "tools",
